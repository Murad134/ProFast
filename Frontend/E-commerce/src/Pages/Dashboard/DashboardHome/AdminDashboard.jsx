...
//   pending: <FaHourglassHalf className="text-3xl text-yellow-600" />,
//   cancelled: <FaTimesCircle className="text-3xl text-red-600" />,
//   service_center_delivered: <FaWarehouse className="text-3xl text-blue-600" />
// };
...
//   if (isError) {
//     return (
//       <div className="alert alert-error shadow m-4 flex items-center gap-2">
...
//             <div
//               key={index}
//               className={`card shadow-md p-4 flex flex-row items-center gap-4 ${
//                 statusBgConfig[stat.status] || 'bg-base-200'
//               }`}
//             >
//               <div className="text-4xl">
//                 {statusIconConfig[stat.status] || <FaBoxOpen className="text-gray-600" />}
//               </div>
//               <div>
//                 <h3 className="stat-title text-lg capitalize">{safeStatus.replace(/_/g, ' ')}</h3>
//                 <p className="stat-value text-3xl font-bold">{safeCount}</p>
//                 <p className="stat-desc">Total parcels</p>
//               </div>
//             </div>
//           );
//         })}
